package com.app.movingpoc.activity;
...
import com.app.movingpoc.adapter.InnerAdapter;
import com.app.movingpoc.adapter.OuterAdapter;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnTouchListener {
    ...
    private OuterAdapter mTrainingPagerAdapter;
    private InnerAdapter mTrainingInsetPagerAdapter;
    ...
    private void nextPagerItem() {
        ...
        if (nextPage == 0) {
            mInsetLayout.startAnimation(AnimationUtils.rightToLeftExitAnimation(AnimationUtils.OFFSET_3));
            mInsetLayout.postDelayed(new Runnable() {
                @Override
                public void run() {
                    mInsetLayout.setVisibility(View.INVISIBLE);
                }
            }, AnimationUtils.OFFSET_3);
        }
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                if (nextPage == 0) {
                    ...
                    mInsetLayout.startAnimation(AnimationUtils.rightToLeftEnterAnimation(AnimationUtils.OFFSET_0));
                } else {
    ...
    private void previousPagerItem() {
        ...
        if (previousPage == 0) {
            mInsetLayout.startAnimation(AnimationUtils.leftToRightExitAnimation(AnimationUtils.OFFSET_3));
            mInsetLayout.postDelayed(new Runnable() {
                @Override
                public void run() {
                    mInsetLayout.setVisibility(View.INVISIBLE);
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if (previousPage == 0) {
                    ...
                    mInsetLayout.setVisibility(View.VISIBLE);
                    mInsetLayout.startAnimation(AnimationUtils.leftToRightEnterAnimation(AnimationUtils.OFFSET_0));
                } else {
                    mPagerInset.setCurrentItem(mPagerInset.getCurrentItem() - 1, false);
                }
    ...
    private void setUpPager() {
        ...
        mTrainingPagerAdapter = new OuterAdapter(getSupportFragmentManager());
        ...
        mTrainingInsetPagerAdapter = new InnerAdapter(getSupportFragmentManager());
